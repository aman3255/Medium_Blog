...
export const Auth = ({ type } : {type: "signup" | "signin"}) => {
    ...
    async function sendRequest() {
        try {
            ...
            alert("Error while signing in or signing up. Please try again.");
        }
    }
            ...
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        ...
                        <LabelledInput 
                            label="Username" 
                            placeholder="Jhon321@gmail.com" 
                            onChange={(e) => {
                                setPostInputs({
                                    ...postInputs,
                                    username: e.target.value // Fixed: was 'name' instead of 'username'
                                })
                            }} 
                        />
                        ...
                        <LabelledInput 
                            ...
                            onChange={(e) => {
                                setPostInputs({
                                    ...postInputs,
                                    password: e.target.value // Fixed: was 'name' instead of 'password'
                                })
                            }} 
                        />
