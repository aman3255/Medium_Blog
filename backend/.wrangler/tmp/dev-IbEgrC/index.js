...
// .wrangler/tmp/bundle-cgGxYL/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-cgGxYL/middleware-insertion-facade.js
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    const user = await prisma.user.create({
      //Here we are using create the user in db.
      data: {
...
app.post("/api/v1/user/signin", async (c) => {
  ...
  try {
    const user = await prisma.user.findFirst({
      //Here we are using findFirst for checking the user.
      where: {
        username: body.username,
        password: body.password
      }
...
blogRouter.post("/", async (c) => {
  ...
  await prisma.blog.create({
    data: {
      ...
      authorId: 1
      // This authorId: 1 will be extarct from jwt in middleware.
    }
  });
...
// src/index.ts
var app2 = new Hono2();
app2.route("/api/v1/user", userRouter);
app2.route("/api/v1/blog", blogRouter);
